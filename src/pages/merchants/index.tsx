...
import { useRoqClient, useMerchantFindManyWithCount } from 'lib/roq';
...
export function MerchantListPage(props: MerchantListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useMerchantFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.merchant.delete({ where: { id } });
      await mutate();
    } catch (error) {
