  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="All Bill Payments App - Payone, Your One-Stop Solution for Collecting Payments from Customers, Streamlining Merchant Transactions for Seamless Business Operations."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwYXltZW50fGVufDB8fHx8MTY5NzYwOTc1NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`All Bill Payments App - Payone, Your One-Stop Solution for Collecting Payments from Customers, Streamlining Merchant Transactions for Seamless Business Operations.`}
            </Text>
            <Box
